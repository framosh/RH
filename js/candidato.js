...
function limpiaPantalla2() {
    ...
    document.getElementById("alta_cand").disabled = false;
...
function actualizaCandidato() {
    ...
    var aviso;
    if (alta == false) {
        aviso = "No tiene permiso para dar de alta";
    ...
    if (candidato_clv == "Seleccione el Candidato") {
...
function altaCandidato() {
    //    alert("Alta de Candidato");
    var aviso;
    if (alta == false) {
        aviso = "No tiene permiso para dar de alta";
        document.getElementById("mensaje_gral").innerHTML = aviso;
    ...
    if (est_cand == "Seleccione el estatus") {
        aviso = "Por favor seleccione el estatus del candidato";
        document.getElementById("mensaje_gral").innerHTML = aviso;
        return;
    }
    ...
    if (est_cand == "Seleccione el estatus del cv") {
        aviso = "Por favor seleccione un estatus del cv";
        document.getElementById("mensaje_gral").innerHTML = aviso;
        return;
    }
    ...
    var camposx23 = camposx22.join("|");
    //var archivo1 = "https://svr.itbp.com.mx/httpdocs/svr_reg_contacto.php";
    var archivo1 = servidor + "httpdocs/reg_Candidato.php";
    var archivo2 = archivo1 + "?campos=" + camposx23;
    var xhttp;
...
function consultaCandidato() {
    ...
    var archivo1 = servidor + "httpdocs/consultaCandidato.php";
...
function Estudios() {
    ...
    $(document).ready(function () {
        var pagina = servidor + "edu_x_cand.htm" + "?candidato=" + candidato_clv + "&cand_nom=" + candidato;
