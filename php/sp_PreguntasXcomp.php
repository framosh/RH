...
$query="SELECT clv_preg_pc, nombre_pregopc, des_preg_xcom FROM Preg_xcom WHERE clv_conocim = '$Clave' ORDER BY nombre_pregpc ASC";
...
function csvFromResult($stream, $result, $showColumnHeaders = true) {
    ...
    if($showColumnHeaders) {
        $separador = '|';
        $encabezado1 = array();
        $encabezado1[0] = "CATALOGO DE PEGUNTAS POR COMPLEMENTO";
