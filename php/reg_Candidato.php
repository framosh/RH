...
foto_dir,foto_nom,fecha_ent,hora_ent,lugar_ent) 
VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)"))
	{
	mysqli_stmt_bind_param($stmt,"ssssssssssssssssssssssssssssssssssss",$campo[0],$campo[1],$campo[2],$campo[3],$campo[4],
